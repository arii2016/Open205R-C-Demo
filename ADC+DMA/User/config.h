...
#define I2Cx_SLAVE_ADDRESS7      0x30
  ...
  #define Open207V_CAN_RX_PIN                 GPIO_Pin_8
  #define Open207V_CAN_TX_PIN                 GPIO_Pin_9
  ...
  #define Open207V_CAN_RX_SOURCE              GPIO_PinSource8
  #define Open207V_CAN_TX_SOURCE              GPIO_PinSource9
#endif       
#ifdef OpenCAN2
  #define Open207V_CANx                       CAN2
  #define Open207V_CAN_CLK                    RCC_APB1Periph_CAN2
  #define Open207V_CAN_RX_PIN                 GPIO_Pin_6
  #define Open207V_CAN_TX_PIN                 GPIO_Pin_12
  #define Open207V_CAN_GPIO_PORT              GPIOB
  #define Open207V_CAN_GPIO_CLK               RCC_AHB1Periph_GPIOB
  #define Open207V_CAN_AF_PORT                GPIO_AF_CAN2
  #define Open207V_CAN_RX_SOURCE              GPIO_PinSource12
...
#ifdef Open207_TOUTH_SPI2
	#define Open207V_TOUTH_SPI                           SPI2

	#define Open207V_TOUTH_SPI_CLK                       RCC_APB1Periph_SPI2
	#define Open207V_TOUTH_SPI_IRQn                      SPI2_IRQn
	#define Open207V_TOUTH_SPI_IRQHANDLER                SPI2_IRQHandler
	
	#define Open207V_TOUTH_SPI_SCK_PIN                   GPIO_Pin_13
	#define Open207V_TOUTH_SPI_SCK_GPIO_PORT             GPIOB
	#define Open207V_TOUTH_SPI_SCK_GPIO_CLK              RCC_AHB1Periph_GPIOB
	#define Open207V_TOUTH_SPI_SCK_SOURCE                GPIO_PinSource13
	#define Open207V_TOUTH_SPI_SCK_AF                    GPIO_AF_SPI2
	
	#define Open207V_TOUTH_SPI_MISO_PIN                  GPIO_Pin_14
	#define Open207V_TOUTH_SPI_MISO_GPIO_PORT            GPIOB
	#define Open207V_TOUTH_SPI_MISO_GPIO_CLK             RCC_AHB1Periph_GPIOB
	#define Open207V_TOUTH_SPI_MISO_SOURCE               GPIO_PinSource14
	#define Open207V_TOUTH_SPI_MISO_AF                   GPIO_AF_SPI2
	
	#define Open207V_TOUTH_SPI_MOSI_PIN                  GPIO_Pin_15
	#define Open207V_TOUTH_SPI_MOSI_GPIO_PORT            GPIOB
	#define Open207V_TOUTH_SPI_MOSI_GPIO_CLK             RCC_AHB1Periph_GPIOB
	#define Open207V_TOUTH_SPI_MOSI_SOURCE               GPIO_PinSource15
	#define Open207V_TOUTH_SPI_MOSI_AF                   GPIO_AF_SPI2
#endif
...
void Open207_JOYSTICK_KEY_Init(void);
