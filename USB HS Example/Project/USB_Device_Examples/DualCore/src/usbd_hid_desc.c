...
uint8_t *  USBD_HID_ProductStrDescriptor( uint8_t speed , uint16_t *length)
{
  ...
  if(speed == 0)
  {   
    USBD_GetString (USBD_HID_PRODUCT_HS_STRING, USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString (USBD_HID_PRODUCT_FS_STRING, USBD_StrDesc, length);    
  }
  return USBD_StrDesc;
}
...
{
  USBD_GetString (USBD_HID_MANUFACTURER_STRING, USBD_StrDesc, length);
  return USBD_StrDesc;
}
...
uint8_t *  USBD_HID_SerialStrDescriptor( uint8_t speed , uint16_t *length)
{
  ...
  {    
    USBD_GetString (USBD_HID_SERIALNUMBER_HS_STRING, USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString (USBD_HID_SERIALNUMBER_FS_STRING, USBD_StrDesc, length);    
  }
  return USBD_StrDesc;
}
...
uint8_t *  USBD_HID_ConfigStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed  == USB_OTG_SPEED_HIGH)
  {  
    USBD_GetString (USBD_HID_CONFIGURATION_HS_STRING, USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString (USBD_HID_CONFIGURATION_FS_STRING, USBD_StrDesc, length); 
  }
  return USBD_StrDesc;  
}
...
uint8_t *  USBD_HID_InterfaceStrDescriptor( uint8_t speed , uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString (USBD_HID_INTERFACE_HS_STRING, USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString (USBD_HID_INTERFACE_FS_STRING, USBD_StrDesc, length);
  }
  return USBD_StrDesc;  
}
