 ...
 */
#define TAMPER_BUTTON_PIN                GPIO_Pin_1
#define TAMPER_BUTTON_GPIO_PORT          GPIOB
#define TAMPER_BUTTON_GPIO_CLK           RCC_AHB1Periph_GPIOB
#define TAMPER_BUTTON_EXTI_LINE          EXTI_Line1
#define TAMPER_BUTTON_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOB
#define TAMPER_BUTTON_EXTI_PIN_SOURCE    EXTI_PinSource1
...
#define KEY_BUTTON_EXTI_PIN_SOURCE       EXTI_PinSource7
