...
int main(void)
{
	...
	I2C_Write(Open205R_I2Cx,ADDR_24LC02,0,WriteBuffer,sizeof(WriteBuffer) );
	printf("\r\n EEPROM 24C02 Write Test OK \r\n");
	
	/* EEPROM读数据 */
	printf("\r\n EEPROM 24C02 Read Test \r\n");
	I2C_Read(Open205R_I2Cx,ADDR_24LC02,0,ReadBuffer,sizeof(WriteBuffer) );
		printf("ReadBuffer: \r\n");
	for(Addr=0; Addr<256; Addr++)
	{
	Addr=ReadBuffer[Addr];	 /* WriteBuffer */
	printf("%d ", Addr);	
	}
