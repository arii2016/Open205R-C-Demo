...
void I2C_Configuration(void)
{
	...
	RCC_AHB1PeriphClockCmd(Open205R_I2Cx_SDA_GPIO_CLK | Open205R_I2Cx_SCL_GPIO_CLK,ENABLE);
	
	RCC_APB1PeriphClockCmd(Open205R_I2Cx_CLK,ENABLE);
	
	GPIO_PinAFConfig(Open205R_I2Cx_SDA_GPIO_PORT, Open205R_I2Cx_SDA_SOURCE, Open205R_I2Cx_SDA_AF);
	GPIO_PinAFConfig(Open205R_I2Cx_SCL_GPIO_PORT, Open205R_I2Cx_SCL_SOURCE, Open205R_I2Cx_SCL_AF);
	
	GPIO_InitStructure.GPIO_Pin =  Open205R_I2Cx_SDA_PIN;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
  	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;
  	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_Init(Open205R_I2Cx_SDA_GPIO_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin =  Open205R_I2Cx_SCL_PIN;
	GPIO_Init(Open205R_I2Cx_SCL_GPIO_PORT, &GPIO_InitStructure);
		
	I2C_DeInit(Open205R_I2Cx);
	...
	I2C_Cmd(Open205R_I2Cx, ENABLE);
	I2C_Init(Open205R_I2Cx, &I2C_InitStructure);
	
	I2C_AcknowledgeConfig(Open205R_I2Cx, ENABLE);
}
